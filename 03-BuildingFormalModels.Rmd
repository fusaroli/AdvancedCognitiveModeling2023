...
> prerequisite for Ch. 4, where we reverse the direction: given observed data,
...
**Coming up in Chapter 4:** We reverse the arrow. The simulated data we just
...
foundation; in Chapter 5, we will then stress-test the entire inference
