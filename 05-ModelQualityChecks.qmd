...
The six-phase validation pipeline requires **thousands of Stan fits** during SBC (Simulation-Based Calibration). Each SBC iteration only needs to verify posterior calibration — it does **not** need:
