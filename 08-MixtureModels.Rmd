...
> attentional lapses). Mixture models extend the toolkit from Ch. 6
> (hierarchical structures) and Ch. 7 (model comparison via LOO) to this
...
```{r ch8-load-data}
d    <- read_csv(here("simdata", "04_randomnoise.csv"), show_col_types = FALSE)
...
**Coming up in Chapter 9:** We leave the matching-pennies domain entirely
