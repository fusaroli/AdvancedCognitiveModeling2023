...
weighted_population_ratio_mean <- 0.0     # Mean weight ratio (log-scale, 0 = equal weights)
...
p_agent_comp <- ggplot(elpd_by_agent, aes(x = model_type, y = elpd_diff, fill = better_model)) +
  geom_boxplot() +
  ...
  scale_fill_manual(values = c("Simple" = "blue", "Weighted" = "red")) +
  theme_minimal()
