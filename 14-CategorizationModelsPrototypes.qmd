...
We use Pathfinder initialization before HMC sampling. Theoretically, it should make the model better. I haven't tested that yet, shamefully, but it doesn't hurt to do it.
