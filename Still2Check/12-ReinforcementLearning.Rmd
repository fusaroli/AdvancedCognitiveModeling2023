...
[Discussion of how RL assumes different landscapes to be optimal: low rate: noisy environment with slow to no change; high rate: volatile environment. In both cases, a constant learning rate, which might not be optimal e.g. in seasonal changes]
