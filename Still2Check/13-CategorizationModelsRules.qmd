...
```{r ch14_rule_set_sensitivity, eval=run_intensive_checks}
...
```{r ch14_max_dims_sensitivity, eval=run_intensive_checks}
...
```{r ch14_resample_threshold_sensitivity, eval=run_intensive_checks}
...
```{r ch14_cross_model_check, eval=run_intensive_checks}
...
cross_results <- compute_SBC(
  ...
  cache_path = here("simdata", "ch14_cross_model_check_cache"),
  keep_fits = FALSE
)
...
```{r ch14_real_sbc_model_B, eval=run_intensive_checks}
...
real_sbc_results <- compute_SBC(
  ...
  cache_path = here("simdata", "ch14_real_sbc_cache"),
  keep_fits = FALSE
)
...
```{r ch14_psbc_model_B, eval=run_intensive_checks}
...
if (!is.null(fit_rule_stan)) {
  ...
  psbc_results <- compute_SBC(
    ...
    cache_path = here("simdata", "ch14_psbc_cache"),
    keep_fits = FALSE
  )
...
```{r ch14_npe_setup, eval=run_intensive_checks}
# ── Python environment ────────────────────────────────────────────────────────
