...
if (regenerate_simulations) {
  ...
  fit_simple_balanced$save_object("simmodels/ch9_fit_simple_balanced.rds")
  fit_simple_self_focused$save_object("simmodels/ch9_fit_simple_self_focused.rds")
  fit_simple_socially_influenced$save_object("simmodels/ch9_fit_simple_socially_influenced.rds")
  fit_weighted_balanced$save_object("simmodels/ch9_fit_weighted_balanced.rds")
  fit_weighted_self_focused$save_object("simmodels/ch9_fit_weighted_self_focused.rds")
  fit_weighted_socially_influenced$save_object("simmodels/ch9_fit_weighted_socially_influenced.rds")
  
  cat("Generated and saved new model fits\n")
} else {
  # Load existing model fits
  fit_simple_balanced <- readRDS("simmodels/ch9_fit_simple_balanced.rds")
  fit_simple_self_focused <- readRDS("simmodels/ch9_fit_simple_self_focused.rds")
  fit_simple_socially_influenced <- readRDS("simmodels/ch9_fit_simple_socially_influenced.rds")
  fit_weighted_balanced <- readRDS("simmodels/ch9_fit_weighted_balanced.rds")
  fit_weighted_self_focused <- readRDS("simmodels/ch9_fit_weighted_self_focused.rds")
  fit_weighted_socially_influenced <- readRDS("simmodels/ch9_fit_weighted_socially_influenced.rds")
...
write_stan_file(
  multilevel_simple_stan,
  dir = "stan/",
  basename = "ch9_multilevel_simple_beta_binomial.stan"
)
```
...
write_stan_file(
  multilevel_weighted_stan,
  dir = "stan/",
  basename = "ch9_multilevel_weighted_beta_binomial.stan"
)
```
...
file_simple_ml <- file.path("stan/ch9_multilevel_simple_beta_binomial.stan")
file_weighted_ml <- file.path("stan/ch9_multilevel_weighted_beta_binomial.stan")
...
if (regenerate_simulations) {
  ...
  # Save model fits for future use
  fit_simple_ml$save_object("simmodels/ch9_fit_multilevel_simple_mixed.rds")
  fit_weighted_ml$save_object("simmodels/ch9_fit_multilevel_weighted_mixed.rds")
  
  cat("Models fitted and saved.\n")
} else {
  # Load existing model fits
  fit_simple_ml <- readRDS("simmodels/ch9_fit_multilevel_simple_mixed.rds")
  fit_weighted_ml <- readRDS("simmodels/ch9_fit_multilevel_weighted_mixed.rds")
...
if (regenerate_simulations) {
  ...
  # Save model fits
  fit_seq_single$save_object("simmodels/ch9_fit_sequential_single.rds")
  fit_seq_multilevel$save_object("simmodels/ch9_fit_sequential_multilevel.rds")
  
  cat("Models fitted and saved.\n")
} else {
  # Load existing model fits
  fit_seq_single <- readRDS("simmodels/ch9_fit_sequential_single.rds")
  fit_seq_multilevel <- readRDS("simmodels/ch9_fit_sequential_multilevel.rds")
