...
These are the teaching notes for Advanced Cognitive Modeling - taught in 2025 at the M.Sc. in Cognitive Science at Aarhus University (and building on previous years).

1. The syllabus is available at TBA
2. The videos are available at TBA
...
* up-to-date R (version 4.4 or above) and Rstudio (version 2024.12.0 or above) installed and working. See here for a more detailed instruction on how to install R and Rstudio: https://happygitwithr.com/install-r-rstudio.html
